...
/***/ (function(module, exports, __webpack_require__) {
	...
	function startBoard() {
	  ...
	  var selection = diffSelect.children[diffSelect.selectedIndex];
	  var height = +selection.dataset.height;
	  var width = +selection.dataset.width;
	  var mines = +selection.dataset.mines;
	  board = new _board.Board(width, height, mines);
	...
	boardElement.addEventListener("contextmenu", function (event) {
	  ...
	  if (target.classList.contains("spot")) {
	    ...
	    if (board.spots[index].cleared) {
	      var neighbors = board.neighbors(index);
	      var countFlags = 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Board = exports.Board = function () {
	   ...
	   */
	  function Board() {
	    var width = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 30;
	    var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 15;
	    var mines = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 20;
	  ...
	  _createClass(Board, [{
	    ...
	    value: function generateBoard() {
	      ...
	      for (var i = 0; i < this.height * this.width; i++) {
	        this.spots.push({ cleared: false, mine: false, flagged: false });
	      }
	    }
	    ...
	    value: function addMines() {
	      ...
	      while (mineLocations.length < this.mines) {
	        var randomLocation = _lodash2.default.random(this.spots.length - 1);
	    ...
	    key: 'clearSpot',
	    value: function clearSpot(i) {
	      if (!this.spots[i].cleared && !this.spots[i].flagged) {
	    ...
	    key: 'countFlags',
	    value: function countFlags() {
	      var flags = 0;
	      for (var i = 0; i < this.spots.length; i++) {
	        if (this.spots[i].flagged) {
	          flags++;
	        }
	      }
	      return flags;
